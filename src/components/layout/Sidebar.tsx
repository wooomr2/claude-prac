...
function LeafIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
      <path d="M10 2C6 2 2 6 2 10c0 2 1 3.5 2.5 4.5C6 15.5 8 16 10 16c4 0 8-3 8-7 0-2-1-4-3-5.5C13.5 2.5 11.8 2 10 2z" />
      <path d="M10 16v2" strokeWidth="2" stroke="currentColor" fill="none" />
    </svg>
  );
}
function DropIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
      <path d="M10 2L5 10a5 5 0 1010 0L10 2z" />
    </svg>
  );
}
function ChartIcon() {
...
function CalIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
      ...
      <path d="M6 2v4M14 2v4M2 9h16" stroke="currentColor" strokeWidth="1.5" fill="none" />
    </svg>
  );
}
...
const Sidebar = () => (
  <aside
    className="flex flex-col items-center py-5 gap-1 shrink-0 border-r"
    style={{ width: 64, background: '#080f0b', borderColor: '#1a3020' }}
  >
    <div
      className="mb-5 w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs"
