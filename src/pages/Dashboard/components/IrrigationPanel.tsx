  ...
  <div className="rounded-xl border flex flex-col p-4" style={{ background: "#090f0b", borderColor: "#1a3020" }}>
    <div className="flex items-center justify-between mb-3">
      <div>
        ...
        <p className="text-[11px] mt-0.5" style={{ color: "#374151" }}>오늘 스케줄 · 5건</p>
      </div>
      <button
      ...
      {IRRIGATION.map((item) => (
        ...
        >
          <div
            ...
            style={{ background: item.done ? "#111c14" : "rgba(34,197,94,0.12)", color: item.done ? "#2d4a35" : "#22c55e" }}
          >
            {item.zone}
          </div>
          ...
          <span className="font-mono" style={{ color: "#374151" }}>{item.time}</span>
          <span style={{ color: "#374151" }}>{item.duration}분</span>
          <span className="ml-auto font-mono" style={{ color: "#06b6d4" }}>{item.volume}L</span>
          <span
