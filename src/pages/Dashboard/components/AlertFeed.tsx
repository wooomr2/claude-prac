  ...
  <div className="rounded-xl border flex flex-col p-4" style={{ background: "#090f0b", borderColor: "#1a3020" }}>
    <div className="flex items-center justify-between mb-3">
      <div>
        ...
        <p className="text-[11px] mt-0.5" style={{ color: "#374151" }}>최근 12시간 이벤트</p>
      </div>
      <span className="text-[10px] px-2 py-0.5 rounded-full font-mono" style={{ background: "rgba(245,158,11,0.1)", color: "#f59e0b" }}>
        2 미확인
      </span>
    </div>
          ...
          <div key={a.id} className="flex items-start gap-2.5 p-2.5 rounded-lg" style={{ background: s.bg }}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[12px] font-medium truncate" style={{ color: s.text, fontFamily: "Noto Sans KR, sans-serif" }}>
                  {a.message}
                </span>
                <span className="text-[10px] font-mono shrink-0" style={{ color: "#374151" }}>{a.time}</span>
              </div>
