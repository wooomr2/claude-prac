...
export const TEMP_HISTORY = [
  ...
  22.9, 22.5, 22.1, 21.8, 24.3,
];
export const HUMID_HISTORY = [
  72, 71, 70, 69, 70, 71, 68, 67, 66, 67, 67, 66, 65, 66, 68, 68, 69, 70, 71, 70, 71, 72, 71, 67,
];
export const CO2_HISTORY = [
  680, 700, 720, 730, 750, 770, 790, 810, 830, 840, 842, 838, 825, 820, 830, 840, 842, 850, 845, 840, 838, 835, 840,
  842,
];
export const LIGHT_HISTORY = [
  0, 0, 0, 0, 200, 4000, 14000, 24000, 32000, 37000, 40000, 41500, 42000, 41000, 39000, 36000, 30000, 22000, 13000,
  5000, 800, 0, 0, 0,
];
...
export const ALERTS: {
...
}[] = [
  {
    ...
    type: 'warning',
    zone: 'C',
    message: '구역 C 습도 임계값 미달',
    detail: '현재 62%  |  권장 70% 이상',
    time: '09:43',
  },
  { id: 2, type: 'info', zone: 'A', message: '구역 A 오전 관수 완료', detail: '15분 운영 · 45L 공급', time: '09:30' },
  {
    ...
    type: 'success',
    zone: 'D',
    message: '구역 D 수확 예정 (2일)',
    detail: '파프리카 수확 가능 상태',
    time: '09:15',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    type: 'info',
    zone: 'B',
    message: '영양액 교체 3일 후 예정',
    detail: 'EC 조정 및 pH 체크 권장',
    time: '08:30',
  },
];
